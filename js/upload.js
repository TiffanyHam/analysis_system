$(function() {
    ...
    $(".file").change(function() {
        ...
        var imgContainer = $(this).parents(".aui_photo");
        //存放图片的父元素
        ...
        if (fileList.length > 3 || totalNum > 3) {
            ...
            for (var i = 0; i < fileList.length; i++) {
                ...
                $img0.attr("src", "image/close.png").appendTo($section);
    ...
    $(".aui_photo").delegate(".aui-close-up-img", "click", function() {
        $(".aui-works-mask").show();
        delParent = $(this).parent();
    });
    ...
    $(".aui-accept-ok").click(function() {
        ...
        if (numUp < 3) {
            delParent.parent().find(".aui_file_up").show();
        }
        delParent.remove();
